...
describe('Roll-up Laboratory: Comprehensive Suite', () => {
    ...
    describe('Scenario 1: Simple Hierarchy', () => {
        ...
        const n004: TaskNode = { id: 'S1_004', title: 'n004', duration: 40, originalDuration: 40, status: 'todo', isAnchored: false, children: [n007, n008] };
        ...
        const n002: TaskNode = { id: 'S1_002', title: 'n002', duration: 20, originalDuration: 20, status: 'todo', isAnchored: false, children: [n003, n004, n005] };
    ...
    describe('Scenario 2: Messy Convergent Graph', () => {
        ...
        const n009: TaskNode = { id: 'S2_009', title: 'n009', duration: 90, originalDuration: 90, status: 'todo', isAnchored: false, children: [n001] };
        const n002: TaskNode = { id: 'S2_002', title: 'n002', duration: 20, status: 'todo', isAnchored: false, children: [] };
        const n010: TaskNode = { id: 'S2_010', title: 'n010', duration: 100, originalDuration: 100, status: 'todo', isAnchored: false, children: [n002] };
        const n006: TaskNode = { id: 'S2_006', title: 'n006', duration: 60, originalDuration: 60, status: 'todo', isAnchored: false, children: [n009, n010] };
    ...
    describe('Scenario 3: Ultra-Messy Circular Graph', () => {
        ...
        const n002: any = { id: 'S3_002', title: 'n002', duration: 20, originalDuration: 20, status: 'todo', isAnchored: false, children: [] };
        const n004: any = { id: 'S3_004', title: 'n004', duration: 40, originalDuration: 40, status: 'todo', isAnchored: false, children: [] };
        const n008: any = { id: 'S3_008', title: 'n008', duration: 80, originalDuration: 80, status: 'todo', isAnchored: false, children: [] };
        const n009: TaskNode = { id: 'S3_009', title: 'n009', duration: 90, originalDuration: 90, status: 'todo', isAnchored: false, children: [n001] };
        const n010: TaskNode = { id: 'S3_010', title: 'n010', duration: 100, originalDuration: 100, status: 'todo', isAnchored: false, children: [n002] };
        const n003: TaskNode = { id: 'S3_003', title: 'n003', duration: 30, originalDuration: 30, status: 'done', isAnchored: false, children: [n009, n010] };

        n002.children = [n003, n004, n005];
        n004.children = [n002, n008];
        n008.children = [n002];

        const n006: TaskNode = { id: 'S3_006', title: 'n006', duration: 60, originalDuration: 60, status: 'todo', isAnchored: false, children: [n009, n010] };
