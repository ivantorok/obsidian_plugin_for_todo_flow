...
describe('getTotalGreedyDuration', () => {
    ...
    it('should handle diamond graphs (deduplication)', () => {
        ...
        const a: TaskNode = { id: 'a', title: 'A', duration: 60, status: 'todo', isAnchored: false, children: [b, c] };
    ...
    it('should prune "done" tasks and their subtrees', () => {
        ...
        const root: TaskNode = { id: 'root', title: 'Root', duration: 60, status: 'todo', isAnchored: false, children: [doneTask] };

        expect(getTotalGreedyDuration(root).total).toBe(60);
    });

    it('should handle cycles gracefully', () => {
        const a: TaskNode = { id: 'a', title: 'A', duration: 30, status: 'todo', isAnchored: false, children: [] };
        const b: TaskNode = { id: 'b', title: 'B', duration: 30, status: 'todo', isAnchored: false, children: [] };
        a.children = [b];
        b.children = [a];
    ...
    it('should show resiliency: find child via todo path even if other path is done', () => {
        ...
        const todoC: TaskNode = { id: 'c', title: 'C', duration: 10, status: 'todo', isAnchored: false, children: [d] };
        const root: TaskNode = { id: 'root', title: 'Root', duration: 60, status: 'todo', isAnchored: false, children: [doneB, todoC] };
    ...
    it('should see updated duration from registry', () => {
        ...
        const parent: TaskNode = { id: 'parent', title: 'Parent', duration: 10, status: 'todo', isAnchored: false, children: [child] };
