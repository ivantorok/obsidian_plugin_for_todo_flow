...
3.  **Conflict & Evidence**: 
    ...
    - **Sanitary Log Policy**: To avoid permission prompts, always direct ephemeral logs (like E2E test output or vitest results) to the current conversation's **artifact directory** instead of the project's default `logs/` folder.
