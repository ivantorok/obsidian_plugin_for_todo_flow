...
*   **Triage Phase**: The [Start Triage](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/FEATURE_INVENTORY.md#L11) view pops up. I use `k` and `j` to sort. I realize I missed a task, so I use the [Quick Add](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/FEATURE_INVENTORY.md#L28) which utilizes [Optimistic UI Locks](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/backlog/BUG-022_optimistic_id_race_condition.md) and [Interaction Tokens](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/backlog/BUG-023_sync_window_race_condition.md) to ensure my rapid sorting isn't interrupted by background file creation.
...
*   **The Adaptive Field Lead (Elias 2.0)**: 
    *   **Capture**: I have an idea on the platform and tap the [Global FAB](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/STRATEGY_LEAN_MOBILE.md#L31) to [append a raw line](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/STRATEGY_LEAN_MOBILE.md#L32) to my mobile inbox. The system uses [Sovereign Interaction Locking](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/backlog/BUG-023_sync_window_race_condition.md) to prevent Obsidian Sync from hijacking the UI while I'm typing.
...
*   **The Refined Executioner (Elias 2.5 - [PLANNED])**: 
    - **Parity**: I tap the [Anchor](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/FEATURE_INVENTORY.md#L40) button to fix my current task time, just as I would on desktop.
    - **Insight**: I glance at the [Position Indicator](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/backlog/FEAT-008_mobile_stack_parity.md) (e.g., "3 of 10") to gauge my progress through the day.
    - **Persistence**: I mark a task as [DONE](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/FEATURE_INVENTORY.md#L43) and trust that the [Victory Lap](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/atlas/MECHANICS/VICTORY_LAP.md) summary will correctly reflect the completed state.
    - **Quick Add**: While in the stack, I tap the [FAB](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/STRATEGY_LEAN_MOBILE.md#L31) to add a new idea directly to my current sequence, utilizing the same [Mobile Triage Experience](file:///home/ivan/projects/obsidian_plugin_for_todo_flow/docs/backlog/FEAT-008_mobile_stack_parity.md).
